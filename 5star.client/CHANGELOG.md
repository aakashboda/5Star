...
- Create Angular project with ng: `ng new 5star.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`5star.client.esproj`).
- Create `launch.json` to enable debugging.
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `5star.client.esproj`).
